...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		x = mainWindow.getarticulacionX();
		y = mainWindow.getarticulacionY();
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(1, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[4]->RenderMesh();
		//Llantas4
		model = modelaux;
		model = glm::translate(model, glm::vec3(-2.0f, -1.9f, -1.5f));
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0, 0.f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0, 1.f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry();

		// Crear la articulacion
		model = modelaux2;
		...
		//dibujar una pequeña esfera (articulacion)
		modelaux = model;
		model = glm::scale(model, glm::vec3(.5f, .5f, .5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.0f, 1.0f);
