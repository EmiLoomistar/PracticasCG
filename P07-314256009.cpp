...
int main()
{
	...
	// luz helicoptero (spotlight)
	spotLights[2] = SpotLight(1.0f, 1.0f, 0.0f, // rgb
		6.0f, 3.0f, // ambient direct
		0.0f, 5.0f, 6.0f, // pos
		0.0f, -1.0f, 0.0f, // dir
		1.0f, 0.09f, 0.032f, // con lin exp
		25.0f); // edge location
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// helicoptero
		spotLights[2].SetPos(glm::vec3(-0.1f + mainWindow.get_pos_x(), 4.75f, 6.0));
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f + mainWindow.get_pos_x(), 5.0f, 6.0)); 
		...
		// carro base
		spotLights[1].SetPos(glm::vec3(0.95f, 0.25f, 16.4f + mainWindow.get_pos_z()));
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f , -0.5f, 14.0f + mainWindow.get_pos_z()));
		modelaux = model;
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// lamp
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -0.99f, 0.0));
