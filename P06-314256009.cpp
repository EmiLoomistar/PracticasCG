...
//		vec1	vec2	vec3		u		v
		-0.5f,	0.0f,	0.5f,		0.3f,	0.51f,	// 1
		0.5f,	0.0f,	0.5f,		0.7f,	0.51f,
		0.0f,	1.0f,	0.0f,		0.5f,	0.72f,

		0.5f,	0.0f,	0.5f,		0.25f,	0.49f,	// 2
		0.5f,	0.0f,	-0.5f,		0.04f,	0.26f,
		0.0f,	1.0f,	0.0f,		0.47f,	0.26f,

		0.5f,	0.0f,	-0.5f,		0.06f,	0.74f, // 3
		-0.5f,	0.0f,	-0.5f,		0.25f,	0.51f,
		0.0f,	1.0f,	0.0f,		0.48f,	0.74f,

		-0.5f,	0.0f,	-0.5f,		0.3f,	0.49f, // 4
		-0.5f,	0.0f,	0.5f,		0.7f,	0.49f,
		0.0f,	1.0f,	0.0f,		0.5f,	0.29f,

		-0.5f,	0.0f,	0.5f,		0.94f,	0.76f, // 5
		0.5f,	0.0f,	0.5f,		0.75f,	0.98f,
		0.0f,	-1.0f,	0.0f,		0.52f,	0.76f,

		0.5f,	0.0f,	0.5f,		0.95f,	0.26f, // 6
		0.5f,	0.0f,	-0.5f,		0.75f,	0.49f,
		0.0f,	-1.0f,	0.0f,		0.52f,	0.26f,

		0.5f,	0.0f,	-0.5f,		0.75f,	0.51f, // 7
		-0.5f,	0.0f,	-0.5f,		0.97f,	0.74f,
		0.0f,	-1.0f,	0.0f,		0.52f,	0.74f,

		-0.5f,	0.0f,	-0.5f,		0.75f,	0.03f, // 8
		-0.5f,	0.0f,	0.5f,		0.97f,	0.23f,
		0.0f,	-1.0f,	0.0f,		0.52f,	0.24f,
	};
...
int main()
{
	...
	dadoTexture = Texture("Textures/dado_animales_2.tga");
	dadoTexture.LoadTextureA();
	logofiTexture = Texture("Textures/escudo_fi_color.tga");
	logofiTexture.LoadTextureA();
	diceTexture = Texture("Textures/dice.jpg");
	diceTexture.LoadTextureA();
	...
	Dado_B = Model();
	Dado_B.LoadModel("Models/dado_blender.obj");
	carro_model = Model();
	carro_model.LoadModel("Models/carro.obj");
	caucho_model = Model();
	caucho_model.LoadModel("Models/llanta_caucho.obj");
	rin_model = Model();
	rin_model.LoadModel("Models/llanta_rin.obj");
	cofre_model = Model();
	cofre_model.LoadModel("Models/carro_cofre.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		modelaux = model;
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		carro_model.RenderModel();
		// Llantas
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.2f, 0.0f, 1.85f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		caucho_model.RenderModel();
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.2f, 0.0f, 1.85f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		rin_model.RenderModel();
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.2f, 0.0f, 1.85f));
		...
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.2f, 0.0f, -1.39f));
		...
		// Cofre
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 0.95f, 0.95f));
		model = glm::rotate(model, -glm::radians(mainWindow.getarticulacion1()), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		cofre_model.RenderModel();
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
