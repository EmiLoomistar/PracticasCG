...
int main()
{
	...
	carro = Model();
	carro.LoadModel("Models/carro_base.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// carro
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -1.4f, mainWindow.get_position()));
		modelaux = model;
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.0f, 0.0f, 1.9f));
		...
		// cofre
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 1.02f, 1.1f));
